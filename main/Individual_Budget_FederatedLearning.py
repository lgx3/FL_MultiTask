...
def main():
    ...
    plt.grid()
    plt.legend()
    plt.savefig('D:/Code/WorkPlace/pythonWork/FL_MultiTask/save/Individual_Budget_FederatedLearning/20230320_实验1_0.2_5_TaskQuality.png')
    plt.show()
    ...
    plt.grid()
    plt.legend()
    plt.savefig('D:/Code/WorkPlace/pythonWork/FL_MultiTask/save/Individual_Budget_FederatedLearning/20230320_实验1_0.2_5_mnist.png')
    plt.show()
    ...
    plt.grid()
    plt.legend()
    plt.savefig('D:/Code/WorkPlace/pythonWork/FL_MultiTask/save/Individual_Budget_FederatedLearning/20230320_实验1_0.2_5_fmnist.png')
    plt.show()
    ...
    plt.grid()
    plt.legend()
    plt.savefig('D:/Code/WorkPlace/pythonWork/FL_MultiTask/save/Individual_Budget_FederatedLearning/20230320_实验1_0.2_5_cifar10.png')
    plt.show()
    ...
    plt.grid()
    plt.legend()
    plt.savefig('D:/Code/WorkPlace/pythonWork/FL_MultiTask/save/Individual_Budget_FederatedLearning/20230320_实验1_0.2_5_算法平均精度.png')
    plt.show()
