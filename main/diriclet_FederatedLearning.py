...
def main():
    ...
    dict_users, client_dict = getAllClientDataDistribution(train_dataset_list, args, n_class=10)
    ...
    for task in Task:
        ...
        if task == 0:
            acc_test, acc_all_mnist = fl_training(client_selected_every_task_q[task], dic_users, p, dataset_train, dataset_test, args, dataset_name[task])
            print("EMD-MQFL选择时，mnist选中客户端参与训练的准确率：{}".format(acc_all_mnist))

            BidPrice_first_acc_test, BidPrice_first_acc_all_mnist = fl_training(Bidfirst_client_selected[task],dic_users, p, dataset_train,dataset_test, args, dataset_name[task])
            print("报价优先选择时，mnist选中客户端参与训练的准确率：{}".format(BidPrice_first_acc_all_mnist))

            Knapsack_greedy_acc_test, Knapsack_greedy_acc_all_mnist = fl_training(Knapsack_greedy_client_selected[task],dic_users, p, dataset_train,dataset_test, args, dataset_name[task])
            print("背包贪婪选择时，mnist选中客户端参与训练的准确率：{}".format(Knapsack_greedy_acc_all_mnist))

            Random_acc_test, Random_acc_all_mnist = fl_training(Random_client_selected[task],dic_users, p, dataset_train,dataset_test, args, dataset_name[task])
        ...
        if task == 1:
            ...
            BidPrice_first_acc_test, BidPrice_first_acc_all_fmnist = fl_training(Bidfirst_client_selected[task], dic_users, p, dataset_train, dataset_test, args, dataset_name[task])
            print("报价优先选择时，fmnist选中客户端参与训练的准确率：{}".format(BidPrice_first_acc_all_fmnist))

            Knapsack_greedy_acc_test, Knapsack_greedy_acc_all_fmnist = fl_training(Knapsack_greedy_client_selected[task],dic_users, p, dataset_train,dataset_test, args, dataset_name[task])
            print("背包贪婪选择时，fmnist选中客户端参与训练的准确率：{}".format(Knapsack_greedy_acc_all_fmnist))

            Random_acc_test, Random_acc_all_fmnist = fl_training(Random_client_selected[task],dic_users, p, dataset_train,dataset_test, args, dataset_name[task])
        ...
        if task == 2:
            ...
            BidPrice_first_acc_test, BidPrice_first_acc_all_cifar10 = fl_training(Bidfirst_client_selected[task],dic_users, p, dataset_train,dataset_test, args, dataset_name[task])
            print("报价优先选择时，cifar10选中客户端参与训练的准确率：{}".format(BidPrice_first_acc_all_cifar10))

            Knapsack_greedy_acc_test, Knapsack_greedy_acc_all_cifar10 = fl_training(Knapsack_greedy_client_selected[task],dic_users, p, dataset_train,dataset_test, args,dataset_name[task])
            print("背包贪婪选择时，cifar10选中客户端参与训练的准确率：{}".format(Knapsack_greedy_acc_all_cifar10))

            Random_acc_test, Random_acc_all_cifar10 = fl_training(Random_client_selected[task],dic_users, p, dataset_train,dataset_test, args,dataset_name[task])
    ...
    plt.grid()
    plt.legend()
    plt.savefig('D:/Code/WorkPlace/pythonWork/FL_MultiTask/save/Individual_Budget_FederatedLearning/20230310_实验1_1_5_TaskQuality.png')
    plt.show()
    ...
    plt.grid()
    plt.legend()
    plt.savefig('D:/Code/WorkPlace/pythonWork/FL_MultiTask/save/Individual_Budget_FederatedLearning/20230310_实验1_1_5_mnist.png')
    plt.show()
    ...
    plt.grid()
    plt.legend()
    plt.savefig('D:/Code/WorkPlace/pythonWork/FL_MultiTask/save/Individual_Budget_FederatedLearning/20230310_实验1_1_5_fmnist.png')
    plt.show()
    ...
    plt.grid()
    plt.legend()
    plt.savefig('D:/Code/WorkPlace/pythonWork/FL_MultiTask/save/Individual_Budget_FederatedLearning/20230310_实验1_1_5_cifar10.png')
    plt.show()
    ...
    plt.grid()
    plt.legend()
    plt.savefig('D:/Code/WorkPlace/pythonWork/FL_MultiTask/save/Individual_Budget_FederatedLearning/20230310_实验1_1_5_算法平均精度.png')
    plt.show()
