...
def main():
    ...
    plt.grid()
    plt.legend()
    plt.savefig('D:/Federated_Learning_experiments/FL_MultiTask/save/Task3_experiment_conclusion/20230228_实验1_0.5_3_TaskQuality.png',dpi=600)
    plt.show()
    ...
    plt.grid()
    plt.legend()
    plt.savefig('D:/Federated_Learning_experiments/FL_MultiTask/save/Task3_experiment_conclusion/20230228_实验1_0.5_3_mnist.png',dpi=400)
    plt.show()
    ...
    plt.grid()
    plt.legend()
    plt.savefig('D:/Federated_Learning_experiments/FL_MultiTask/save/Task3_experiment_conclusion/20230228_实验1_0.5_3_fmnist.png', dpi=400)
    plt.show()
    ...
    plt.grid()
    plt.legend()
    plt.savefig('D:/Federated_Learning_experiments/FL_MultiTask/save/Task3_experiment_conclusion/20230228_实验1_0.5_3_cifar10.png', dpi=400)
    plt.show()
    ...
    plt.grid()
    plt.legend()
    plt.savefig('D:/Federated_Learning_experiments/FL_MultiTask/save/Task3_experiment_conclusion/20230228_实验1_0.5_3_算法平均精度.png',dpi=400)
    plt.show()
