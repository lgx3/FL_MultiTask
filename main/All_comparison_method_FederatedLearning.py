...
def main():
        ...
        if iter == 0:
            ...
            for task in Task:
                ...
                if task == 2:
                    ...
                    acc_test_cifar10, loss_locals_cifar10, loss_test_cifar10, w_global_cifar10 = one_epoch_fl_training(client[task], dict_users_cifar10, p, dataset_train, dataset_test, args, dataset_name[task],
                        iter)
    ...
    # plt.plot(X, Fair_Acc_mnist, 'r:', marker='o', ms=3, label='mnist')
    # plt.plot(X, Fair_Acc_fmnist, 'g:', marker='*', ms=3, label='fmnist')
    # plt.plot(X, Fair_Acc_cifar10, 'k:', marker='P', ms=3, label='cifar10')
    # plt.title('FAIR')
    # plt.xlabel("epochs")
    # plt.ylabel("Accuracy")
    ...
    # plt.grid()
    # plt.legend()
    # plt.savefig('D:/Code/WorkPlace/pythonWork/FL_MultiTask/save/Fair/20230320_实验4_0.2_5_FAIR1.png')
    # plt.show()
    ...
    plt.grid()
    plt.legend()
    plt.savefig('D:/Code/WorkPlace/pythonWork/FL_MultiTask/save/All_comparison_method_FederatedLearning/20230322_实验1_0.5_5_TaskQuality.png')
    plt.show()
    ...
    plt.grid()
    plt.legend()
    plt.savefig('D:/Code/WorkPlace/pythonWork/FL_MultiTask/save/All_comparison_method_FederatedLearning/20230322_实验1_0.5_5_mnist.png')
    plt.show()
    ...
    plt.grid()
    plt.legend()
    plt.savefig('D:/Code/WorkPlace/pythonWork/FL_MultiTask/save/All_comparison_method_FederatedLearning/20230322_实验1_0.5_5_fmnist.png')
    plt.show()
    ...
    plt.grid()
    plt.legend()
    plt.savefig('D:/Code/WorkPlace/pythonWork/FL_MultiTask/save/All_comparison_method_FederatedLearning/20230322_实验1_0.5_5_cifar10.png')
    plt.show()
    ...
    plt.grid()
    plt.legend()
    plt.savefig('D:/Code/WorkPlace/pythonWork/FL_MultiTask/save/All_comparison_method_FederatedLearning/20230322_实验1_0.5_5_算法平均精度.png')
    plt.show()
